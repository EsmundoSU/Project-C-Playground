# Based on: https://github.com/lefticus/cpp_starter_project/blob/master/cmake/Sanitizers.cmake
function(enable_sanitizers project_name)
  ...
  if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
    ...
    if (ENABLE_COVERAGE)
      message(STATUS "Sanitizer - enable coverage")
    ...
    if (ENABLE_SANITIZER_ADDRESS)
      message(STATUS "Sanitizer - appended address sanitizer")
      list(APPEND SANITIZERS "address")
    endif ()

    option(ENABLE_SANITIZER_LEAK "Enable leak sanitizer" TRUE)
    if (ENABLE_SANITIZER_LEAK)
      message(STATUS "Sanitizer - appended leak sanitizer")
      list(APPEND SANITIZERS "leak")
    endif ()

    option(ENABLE_SANITIZER_UNDEFINED_BEHAVIOR "Enable undefined behavior sanitizer" TRUE)
    if (ENABLE_SANITIZER_UNDEFINED_BEHAVIOR)
      message(STATUS "Sanitizer - appended undefined behaviour sanitizer")
